            ...
            <nav aria-label="breadcrumb" class="breadcrumb-nav border-0 mb-0">
                <div class="container">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" href="about"aria-current="page">About us</li>
                    </ol>
                </div><!-- End .container -->
                ...
                <div class="container">
                        ...
                        <div class="col-lg-7">
                            <div class="brands-display">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{url('public')}}/assets/images/brands/8.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="{{url('public')}}/assets/images/brands/9.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->
                                </div><!-- End .row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{url('public')}}/assets/images/team/member-1.jpg" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{url('public')}}/assets/images/team/member-2.jpg" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="{{url('public')}}/assets/images/team/member-3.jpg" alt="member photo">
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl" 
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="{{url('public')}}/assets/images/testimonials/user-1.jpg" alt="user">
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="{{url('public')}}/assets/images/testimonials/user-2.jpg" alt="user">
